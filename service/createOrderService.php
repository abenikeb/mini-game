...
class CreateOrderService
{
    ...
    function createOrder()
    {
        ...
        // Obtain a fabric token using ApplyFabricToken class
        ...
        $fabricToken = $result->token; // now we get a fabric token 

        // Make a request to create an order using the obtained fabric token
