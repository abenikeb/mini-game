                    ...
                    <form id="game">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted"><i class="fas fa-info-circle mr-2"></i> @lang('Minimum')
                                ...
                                | @lang('Maximum')
                                : {{showAmount($game->max_limit) }} {{ __($general->cur_text) }} |
                                 <span class="text--warning">@lang('Win Bonus For This Chance') 
    
                                    <span class="bon">{{ optional($gesBon->first())->percent ?? 0 }}%</span>
...
<script>
    "use strict";
        ...
        $('#start').on('submit', function(e) {
            ...
            var bon = {{ optional($gesBon->first())->percent ?? 0 }};
            start(url, data, bon);
        });
</script>
@endpush